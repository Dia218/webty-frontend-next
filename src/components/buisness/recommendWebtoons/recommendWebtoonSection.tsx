...
const recommendWebtoonSection: React.FC = () => {
    ...
    return <WebtoonList webtoons={webtoons} />;
    }
    // WebtoonList 매개변수 :: webtoons: WebtoonDetailDto[], isHorizontal?: boolean
export default recommendWebtoonSection;
