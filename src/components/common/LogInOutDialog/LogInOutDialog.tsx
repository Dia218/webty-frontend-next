...
const LogInOutDialog = () => {
  ...
  return (
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>{isLoggedIn ? "로그아웃 하시겠습니까?" : "로그인"}</AlertDialogTitle>
        ...
        <AlertDialogFooter>
          {isLoggedIn ? (
            ...
            <div onClick={handleLogin} className="cursor-pointer flex items-center">
              <Image src="/assets/kakao_login_medium_wide.png" alt="카카오 로그인" width={300} height={45} />
            </div>
          )}
        </AlertDialogFooter>
      </AlertDialogContent>
